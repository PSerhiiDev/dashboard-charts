...
const AgeGroupChart = () => {
  ...
  const calculate_age = (dob: any) => {
   ...
   function ageGroupes() {
    ...
    return { cat18_21, cat21_25, cat25_30, cat30_35, cat35_40, cat40_45, cat45_50, other }
    
    }
  
     const { cat18_21, cat21_25, cat25_30, cat30_35, cat35_40, cat40_45, cat45_50, other } =  ageGroupes();
    ...
    series: [
      {
        ...
        label: {
          alignTo: 'edge',
          //position of pointer labed on the line/under the line
        //  formatter: '{name|{b}}\n{value|{c}}',
        formatter: '{value|{c}}\n',
          minMargin: 5,
          edgeDistance: 30,
